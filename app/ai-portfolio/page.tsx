...
const SAMPLE_DIAGNOSIS: DiagnosisResult = {
  ...
  flowType: 'SELL',
  flowPercentage: 89,
  shortTermOutlook: '단기적으로는 52주 고점 374,500원 대비 현재가의 위치가 주요 관찰 포인트이며, 외국인 순유출 지속 여부와 개인 유입세의 규모가 단기 방향성을 가늠하는 지표로 작용할 수 있습니다.',
  midTermOutlook: '중기적으로는 반도체 업황 회복 속도와 외국인 수급 방향 전환 여부가 주요 변수로 관찰되며, 현재 PER 44.4배 수준의 밸류에이션이 실적 개선과 함께 유지될 수 있을지가 주가 방향성에 영향을 미치는 요인으로 언급됩니다.',
};
