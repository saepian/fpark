...
export function PerformanceSnapshotCard({
  ...
  return (
    <div className="bg-[#1a1f2e] border border-slate-700/50 rounded-2xl overflow-hidden">
      ...
      {isCached && (
        <div className="flex items-center gap-1.5 px-4 pt-2.5 text-[11px] text-amber-500">
      ...
      {benchmark && (
        <p className="px-4 py-2 text-[11px] text-slate-600 border-t border-slate-700/40">
