...
// 원자료를 "날짜 · 등락률 · N일 후 되돌림"의 작은 타임라인으로 직접 노출한다.
// 2026-08-28 수정: 오늘과 유사한 규모(threshold% 이상)의 과거 사례가 없는 게 대다수
// 종목의 기본 상태인 건 맞지만, 예전처럼 카드 자체를 생략하면 "거래대금 배수"(평이한
// 값 1배 안팎도 항상 보여줌)와 시각적 일관성이 깨진다는 지적으로 hasMatches:false여도
// 카드는 항상 그리고, 내부만 "이력 없음" 빈 상태로 바꾼다(사례 목록 대신 짧은 안내문).
